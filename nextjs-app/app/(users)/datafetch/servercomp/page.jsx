...
// Note: The `DataCard` component should be defined in a separate file (e.g., DataCard.jsx) and should handle the data fetching logic for the user based on the provided `userName`. The `Load` component is used as a fallback UI while the `DataCard` is being loaded.
